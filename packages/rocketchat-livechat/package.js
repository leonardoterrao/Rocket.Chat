...
Package.onUse(function(api) {
	...
	api.addFiles('client/views/app/livechatCustomerForm.html', 'client');
	api.addFiles('client/views/app/livechatCustomerForm.js', 'client');
	api.addFiles('client/views/app/livechatCustomers.html', 'client');
	api.addFiles('client/views/app/livechatCustomers.js', 'client');
	...
	api.addFiles('server/methods/removeCustomer.js', 'server');
	...
	api.addFiles('server/methods/saveCustomer.js', 'server');
	...
	api.addFiles('server/publications/livechatCustomers.js', 'server');
